      ...
      {selectedExecutive && (
        <div className="overlay">
          <div className="overlay-content">
            ...
            <h3><strong>Role:</strong> {selectedExecutive.role}</h3>
            <p><strong></strong> {selectedExecutive.about}</p>
